...
.. code-block:: bash
    ...
    $ pacman -Syu $MINGW_PACKAGE_PREFIX-ninja $MINGW_PACKAGE_PREFIX-cmake \
                  $MINGW_PACKAGE_PREFIX-gcc $MINGW_PACKAGE_PREFIX-pkgconf \
                  $MINGW_PACKAGE_PREFIX-openal $MINGW_PACKAGE_PREFIX-freetype \
                  $MINGW_PACKAGE_PREFIX-sdl3 $MINGW_PACKAGE_PREFIX-zlib \
                  $MINGW_PACKAGE_PREFIX-zstd $MINGW_PACKAGE_PREFIX-libpng \
                  $MINGW_PACKAGE_PREFIX-rtmidi $MINGW_PACKAGE_PREFIX-fluidsynth \
                  $MINGW_PACKAGE_PREFIX-libslirp $MINGW_PACKAGE_PREFIX-libsndfile \
...
* Fedora 41 and newer (DNF5)
  ...
  .. code-block:: bash
        ...
        $ sudo dnf install cmake pkg-config ninja-build \
                           ...
                           libsndfile-devel libserialport-devel qt5-linguist \
...
.. code-block:: bash
    ...
    $ brew install cmake ninja pkg-config freetype sdl3 zstd libpng \
                   openal-soft rtmidi libslirp fluid-synth libsndfile \
                   libserialport qt@5
...
.. code-block:: bash
    ...
    $ pkg install cmake pkgconf freetype-gl sdl3 zstd libspng openal-soft \
                  rtmidi qt5 libslirp fluidsynth libsndfile
