...
For more information, see the `COPYING file <https://github.com/86Box/86Box/blob/master/COPYING>`.
...
`Visit our IRC channel <https://kiwiirc.com/client/irc.ringoflightning.net/?nick=86box|?#softhistory>`

`Visit our Discord server <https://discord.gg/QXK9XTv>`
