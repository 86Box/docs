...
Video card to emulate. This box only lists cards supported by the machine's expansion buses. Click |clear| to search for cards by name, bus or model variant. On machines equipped with an on-board video chip, the *Internal device* option enables the on-board video.
