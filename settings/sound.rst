...
Emulation for the Yamaha OPL series of synthesizers (used by many of the emulated cards) is provided by a modified `Nuked OPL3 <https://github.com/nukeykt/Nuked-OPL3>`_ or `ymfm <https://github.com/aaronsgiles/ymfm>`_ library, per the :ref:`selection below <settings/sound:FM synth driver>`. ESFM emulation for ESS cards is provided by the `ESFMu <https://github.com/Kagamiin/ESFMu>`_ library. MOS Technology 6581 SID emulation for the Innovation SSI-2001 is provided by the reSIDfp component of the `libsidplayfp <https://github.com/libsidplayfp/libsidplayfp>`_ library.
