...
Pause emulation of the machine. Press again to resume emulation. You can alternatively press :kbd:`Ctrl`\ +\ :kbd:`Alt`\ +\ :kbd:`F1` (:ref:`customizable <usage/preferences:|key_bindings| Key bindings>`) to pause or resume emulation.
...
Run the emulated machine at the highest speed your host system can handle. Press again to return to normal speed. You can alternatively press :kbd:`Ctrl`\ +\ :kbd:`Alt`\ +\ :kbd:`F` (:ref:`customizable <usage/preferences:|key_bindings| Key bindings>`) to control this option.
...
Force a reset of the emulated machine. Requires confirmation, which can be disabled by checking the *Don't show this message again* box. You can alternatively press :kbd:`Ctrl`\ +\ :kbd:`Alt`\ +\ :kbd:`F12` (:ref:`customizable <usage/preferences:|key_bindings| Key bindings>`) to hard reset.
...
Send a *Ctrl+Alt+Del* (left-most icon) or *Ctrl+Alt+Esc* (right-most icon) key combination to the emulated machine. You can alternatively press :kbd:`Ctrl`\ +\ :kbd:`F12` to send a *Ctrl+Alt+Del* combination, or :kbd:`Ctrl`\ +\ :kbd:`F10` to send *Ctrl+Alt+Esc*; both key combinations are :ref:`customizable <usage/preferences:|key_bindings| Key bindings>`.
